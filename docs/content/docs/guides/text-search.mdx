---
title: Text Search
description: Full-text search capabilities in mongo.do using SQLite FTS5
---
...
mongo.do uses the BM25 algorithm for relevance scoring. Results are automatically sorted by score (highest first).
...
mongo.do translates search operators to SQLite FTS5 MATCH syntax:
