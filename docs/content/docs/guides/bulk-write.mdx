...
description: Execute multiple write operations efficiently in a single batch with mongo.do
---
...
```typescript
import { BulkWriteException } from 'mongo.do'
...
mongo.do provides full TypeScript support for bulk write operations.
...
mongo.do exports type guard functions for checking operation types:
