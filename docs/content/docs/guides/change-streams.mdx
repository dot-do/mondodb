...
description: Real-time notifications for data changes in mongo.do collections
---

# Change Streams

Change streams provide real-time notifications when data changes in your mongo.do collections. You can watch for inserts, updates, replaces, and deletes, and react to changes as they happen. This is ideal for building reactive applications, live dashboards, and real-time synchronization features.
