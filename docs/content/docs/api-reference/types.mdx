---
title: Types
description: TypeScript interfaces and type definitions for mongo.do
---

# Types

mongo.do provides comprehensive TypeScript types for all operations. This reference documents the core types, interfaces, and helper types.
