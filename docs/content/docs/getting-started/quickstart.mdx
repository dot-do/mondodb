---
title: Quick Start
description: Get up and running with MondoDB in minutes
---

# Quick Start

This guide walks you through building a simple REST API with MondoDB in under 5 minutes.
...
```bash
npm create cloudflare@latest my-mondodb-app -- --type hello-world
cd my-mondodb-app
npm install mondodb
```
...
MondoDB supports MongoDB aggregation pipelines for complex queries:
...
Your MondoDB-powered API is now live on Cloudflare's global network!
