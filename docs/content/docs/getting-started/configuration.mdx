---
title: Configuration
description: Configure mongo.do for your application
---

# Configuration

This guide covers all configuration options for mongo.do, from Wrangler settings to client options.

## Wrangler Configuration

mongo.do requires specific Durable Object configuration in your Wrangler settings.

### Minimal Configuration

The minimum required configuration for mongo.do:
...
const testClient = new MongoClient('mongodo://localhost:27017/testdb', {
  maxPoolSize: 100,
  minPoolSize: 0
});
```
...
- `mongodo://localhost:27017/dbname`
- `mongodb://localhost:27017/dbname` (also accepted)
- `mongodo://user:pass@localhost:27017/dbname?options`
